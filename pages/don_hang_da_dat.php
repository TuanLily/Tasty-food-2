<form action="index.php?act=in_hoa_don" method="post">
  ...
  ?>
      ...
      <div class="lsdb-container">
        <div class="lsdb-order">
          <div class="lsdb-heading">Hóa đơn: <?php echo $thanh_toan['id']; ?></div>
          <div class="lsdb-info">Ngày thanh toán: <?php echo $ngay_thanh_toan; ?></div>
          <div class="lsdb-info">Tổng tiền: <?php echo $tong_tien; ?></div>
          <div class="lsdb-info">Phương thức thanh toán: <?php echo $phuong_thuc_don_hang; ?></div>
          <div class="lsdb-info">Tên khách hàng: <?php echo $thanh_toan['thanh_toan_ten']; ?></div>
          <button type="button" class="btnlsdb">Xem chi tiết</button>
          <input type="hidden" name="hoa_don_id" value="<?php echo $thanh_toan['id']; ?>">


          <!-- Nút In hóa đơn -->
          <input type="submit" value="In hóa đơn" id="ihd" name="in_hoa_don">
          <?php
          ...
          ?>
              <div class="lsdb-items">
                <div class="lsdb-item">Tổng cộng có <?php echo $total_items; ?> món ăn</div>
                <div class="lsdb-item">Lịch đặt bàn: <?php echo $info['thoi_gian_dat_ban']; ?></div>
                ...
                <div class="lsdb-items">
                  <table class="bang_thongtin_mon_an">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><?php echo $mon_an_ids[$i]; ?></td>
                          <td><?php echo $ten_mon_ans[$i]; ?></td>
                          <td><?php echo $gia_mon_ans[$i]; ?></td>
                          <td><img src="uploads/<?php echo $hinh_mon_ans[$i]; ?>" alt="<?php echo $ten_mon_ans[$i]; ?>" width="50"></td>
                          <td><?php echo $so_luong_mon_ans[$i]; ?></td>
                        </tr>
                      <?php
                      }
                      ?>
