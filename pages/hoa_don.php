<div class="container_hoadon">
	<div class="header_bottom">
		...
		<div class="header_bottom_taikhoan">
			<p class="header_top_right"><i class="fa-solid fa-location-dot"></i><a href="#"> Địa chỉ: FPT Polytechnic Cần Thơ </a></p>
		...
		<div class="header_bottom_taikhoan">
			...
			<p class="header_top_right"><i class="fa-solid fa-envelope"></i> <a href="#">Email: Tastyfood@gmail.com</a></p>
		</div>
	...
	<table class="table">
		<tr>
			...
			<td><?php echo $_SESSION['info_datban']['ten_kh']; ?></td>
		</tr>
		<tr>
			<th>Email:</th>
			<td><?php echo $_SESSION['info_datban']['email']; ?></td>
		</tr>
		<tr>
			<th>Điện thoại:</th>
			<td><?php echo $_SESSION['info_datban']['sdt']; ?></td>
		</tr>
		<tr>
			<th>Số người:</th>
			<td><?php echo $_SESSION['info_datban']['so_nguoi']; ?></td>
		</tr>
		<tr>
			<th>Thời gian đặt bàn:</th>
			<td><?php echo $_SESSION['info_datban']['thoi_gian_dat_ban']; ?></td>
		</tr>
		<tr>
			<th>Ghi chú:</th>
			<td><?php echo $_SESSION['info_datban']['ghi_chu']; ?></td>
		</tr>
	</table>
